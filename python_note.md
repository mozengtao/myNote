...
[Python Data Model 心智模型：Protocol（协议）+ Duck Typing（鸭子类型）](python/data_model.md)  
[yield 关键字](python/yield.md)  
[Data model](https://docs.python.org/3/reference/datamodel.html)  
[Python Data Model 全部 Protocol 总结（Mental Model + Usage）](python/data_model_protocol.md)  
[Python Tutor: **Visualize code execution**](https://pythontutor.com/index.html)  
...
- [Fluent Python 中文版](https://www.heavybao.com/Uploads/202506/1751260612.pdf)
- [Example code for Fluent Python](https://github.com/fluentpython)
- [Clean Architecture]()
- [**Implementing Domain-Driven Design**](https://github.com/jason4wy/d3/blob/master/Implementing%20Domain-Driven%20Design.pdf)
- [Patterns, Principles, and Practices of Domain-Driven Design](https://github.com/zhenguoli/software-development-ebooks-1/tree/master)
...
- [Domain Driven Design Tackling Complexity in the Heart of Software](https://github.com/gmoral/Books/tree/master)
- [Patterns of Enterprise Application Architecture]()
- [clean-architectures-in-python](https://github.com/ADGEfficiency/programming-resources/blob/master/python/clean-architectures-in-python.pdf)
- [Patterns, Principles, and Practices of Domain-Driven Design](https://github.com/zhenguoli/software-development-ebooks-1/tree/master)
- []()
- []()
- [OBJECT DESIGN Roles, Responsibilities, and Collaborations](https://ptgmedia.pearsoncmg.com/imprint_downloads/informit/op/9780201379433_objectdesign.pdf)
- [OBJECT DESIGN Roles, Responsibilities, and Collaborations](python/Object_Design.pdf)
- [Object Design: Roles, Responsibilities, and Collaborations](https://ptgmedia.pearsoncmg.com/imprint_downloads/informit/op/9780201379433_objectdesign.pdf)
- [Learning Domain-Driven Design](https://pdfhost.io/v/WNX5ob0vd_Learning_DomainDriven_Design)
...
- [DDD + Object Flow + Infrastructure Layer 的组织心智模型](python/ddd_obj_flow_infra_mental_model.md)
...
- [Implementing Domain-Driven Design](https://github.com/zhyhy/Awesome-CS-Books-Warehouse/tree/master/SoftwareEngineering/Architecture)
- [Domain-Driven Design Distilled](https://github.com/munishdell/book-1/blob/master/software-development/domain-driven-design-distilled.pdf)
- [Architecture Patterns with Python]()
- [**Cosmic Python**](https://www.cosmicpython.com/book/preface)
- [**Cosmic Python**](https://github.com/cosmicpython/book/tree/master)
- [DDD (Go)](https://mehdihadeli.github.io/awesome-go-education/ddd/)
- [awesome-ddd](https://github.com/heynickc/awesome-ddd)
- [DDD 概念参考](https://domain-driven-design.org/zh/ddd-concept-reference.html)
- [**ddd-by-examples**](https://github.com/ddd-by-examples/library/tree/master)
- [DDD Library Demo（Python 教学项目：Catalog + Borrowing 两个 Bounded Context）](python/ddd_library_demo/README.md)
...
- [Maintain a Single Layer of Abstraction at a Time | Object-Oriented Design Principles w/ TypeScript](https://khalilstemmler.com/articles/oop-design-principles/maintain-a-single-layer-of-abstraction/)
- [dddsample-core](https://github.com/citerus/dddsample-core)
- [python-ddd](https://github.com/pgorecki/python-ddd)
- [Everything You Need to Know About Domain-Driven Design with Python Microservices!](https://medium.com/@nomannayeem/everything-you-need-to-know-about-domain-driven-design-with-python-microservices-2c2f6556b5b1)
- [python-ddd](https://github.com/qu3vipon/python-ddd)
- [DDD in Python](https://dddinpython.hashnode.dev/)
- [Building the Customer Context: Clean Architecture and DDD in Practice](https://medium.com/@emenaa/building-the-customer-context-clean-architecture-and-ddd-in-practice-2821cdd10ee4)
- [Strategic DDD by Example: Bounded Contexts Mapping](https://levelup.gitconnected.com/strategic-ddd-by-example-bounded-contexts-mapping-d94ffcd45954)
- [Domain-Driven Design- DDD](https://medium.com/@syed.fawzul.azim/domain-driven-design-ddd-52047eaddab0)
...
- [Python Dependency Inversion Principle (DIP) 心智模型教程](python/dip_00_index.md)
- []()
- []()
- []()
- []()
...
[]()  
[]()  
[The contextmanager decorator](https://www.pythonmorsels.com/contextmanager-decorator/)  
[Python Tips](https://book.pythontips.com/en/latest/#)  
[Mastering Context Managers with Python's contextlib Module](https://leapcell.io/blog/mastering-context-managers-with-python-s-contextlib-module)  
[Python Runtime Services](https://pydoc-zh.readthedocs.io/en/latest/library/python.html)  
[Python 3 标准库实例教程](https://learnku.com/docs/pymotw)  
[contextlib](https://liaoxuefeng.com/books/python/built-in-modules/contextlib/index.html)  
[I/O multiplexing](https://myapollo.com.tw/blog/python-socket-io-multiplexing/)  
[]()  
[]()  
[]()  
[]()  
...
[Method Overloading in Python With Practical Examples](https://www.ccbp.in/blog/articles/method-overloading-in-python)  
[How Python’s Multiple Dispatch Works](https://medium.com/@AlexanderObregon/how-pythons-multiple-dispatch-works-8c69e24c45a6)  
[Method Overloading in Python: Explained With Examples](https://www.wscubetech.com/resources/python/method-overloading)  
