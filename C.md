...
[hash](c/hash.md)  
[variable/function naming](c/naming.md)  
[socket](c/socket.md)  
[组合模式](c/composition.md)  
[设计模式](c/design_patterns.md)  
[C 语言函数参数顺序](c/function_param_sequence.md)  
[内存池](c/mem_pool.md)  
[OOP](c/OOP.md)  
[减少函数嵌套层级的方法](c/methods_to_denest.md)  
[依赖注入](c/inject.md)  
[函数指针](c/function_pointer.md)  
[机制与策略分离](c/mechanism_strategy.md)  
[常用函数](c/useful_functions.md)  
[哈希table](c/hash_table.md)  
[C语言可执行程序的数据段大小是如何确定的](c/how_segment_size_decided.md)  
[opaque类型](c/opaque_handle.md)  
[macro + struct + function pointer的应用](c/macro_struct_pointer.md)  
...
├── 01-dynamic-array.md
├── [02-linked-list.md](./c/data_structure/02-linked-list.md)  # 链表
├── [03-hash-table.md](./c/data_structure/03-hash-table.md)  # 哈希表
├── [04-red-black-tree.md](./c/data_structure/04-red-black-tree.md)  # 红黑树
├── [05-bplus-tree.md](./c/data_structure/05-bplus-tree.md)  # B+树
├── [06-stack-queue.md](./c/data_structure/06-stack-queue.md)  # 栈和队列
└── [07-ring-buffer.md](./c/data_structure/07-ring-buffer.md)  # 环形缓冲区
...
## 模块化
[真刀真枪模块化](https://mp.weixin.qq.com/mp/appmsgalbum?__biz=MzAxMzc2ODMzNg==&action=getalbum&album_id=1588719988331364355&scene=173&subscene=&sessionid=svr_839904b1464&enterid=1767926105&from_msgid=2656102469&from_itemidx=1&count=3&nolastread=1#wechat_redirect)  
